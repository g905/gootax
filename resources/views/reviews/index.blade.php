...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
            ...
            <div class="row mb-4">
                <div class='col-12 d-flex'>
                    ...
                    <div class='card w-25 me-2'>
                        <div class='card-title p-2 h-8'>{{ $review->title }} </div>
                        <div class="card-body text-sm text-gray-500 d-flex justify-content-end">{{ $review->city->name }}</div>
                        <div class='card-body p-2'>{{ $review->text }}</div>
                        <div class="card-footer text-sm d-flex justify-content-end">by&nbsp;
                            @if (Auth::user())
                            <button type='button' class='authorBtn' data-author="{{ $review->author->id }}">
                                {{ $review->author->name }}
                            </button>
                            @else
                            {{ $review->author->name }}
        ...
        <div id='loader' style='display: none; position: absolute; top:0; bottom:0;left:0;right:0; text-align: center; opacity: 0.5; background: black;'>
            <div style="position: relative; height: 100%; top: 50%" class="text-lg">loading</div>
        </div>
